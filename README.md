...
1. วัตถุประสงค์การใช้งาน การเวียนเกิด เพื่อแก้ปัญหาบางอย่างที่มีรูปแบบทำซ้ำแบบมีเงื่อนไข แล้วทำไมไม่ใช้วนลูป หรือวนรอบแทน????!!!!! คำตอบคือ เราไม่ต้องจัดการ Stack ที่ใช้ในการเก็บสถานะตัวแปรในแต่ละรอบเอง การเวียนเกิดจะเก็บข้อมูลตัวแปรในแต่ละรอบเองโดยตัวแปลภาษาโปรแกรม (C++ , Python , ... ) แต่ต้องมั่นใจว่าตัวแปลภาษาได้จัดเตรียม Stack ไว้อย่างเพียงพอต่อการทำงาน ไม่เช่นนั้นจะเกิดข้อผิดพลาด Stack Overflow นอกจากนี้หากเราไม่รู้จำนวนรอบในการทำงานที่แน่นอน ก็จะไม่สามารถเขียนโปรแกรมในรูปแบบการวนรอบได้ ลักษณะเช่นนี้เรียกว่าเป็นโปรแกรมแบบเวียนเกิดตามธรรมชาติ เช่นการเดินทางไปในโครงสร้างข้อมูลต้นไม้ที่ไม่รู้ว่ามีข้อมูลกี่ชุด (n) จึงเขียนแบบวนรอบจำนวน n รอบไม่ได้เพราะรู้ค่า n 
1. [VDO การสอน #1](https://youtu.be/8Z2Z7ER7QJo)
1. Factorial !
