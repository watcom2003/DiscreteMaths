...
1. การเวียนเกิด (Recursion) คือการเรียกใช้งานตัวเอง โดยมีเงื่อนไขในการทำงาน 2 กรณีคือ
    1.1. กรณีพื้นฐานคือเป็นกรณีที่หาค่าได้จากการกำหนดค่า เช่น เรารู้ว่าเลขใด ๆ ยกกำลังศูนย์ จะเท่ากับ 1 เสมอ ดังนั้น กรณีนี้เรากำหนดค่าเท่ากับ 1 เสมอไม่ว่าเลขใด
    1.1. กรณีเวียนเกิด (อุปนัย) คือกรณีที่ยังหาค่าไม่ได้ให้เรียกตัวเองในเทอมที่เล็กลงเป็นทอด ๆ เช่น 2^3 = 2 * 2^(3-1) 
