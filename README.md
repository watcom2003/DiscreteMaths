...
1. วัตถุประสงค์การใช้งาน การเวียนเกิด เพื่อแก้ปัญหาบางอย่างที่มีรูปแบบทำซ้ำแบบมีเงื่อนไข แล้วทำไมไม่ใช้วนลูป หรือวนรอบแทน????!!!!! คำตอบคือ เราไม่ได้ต้องจัดการ Stack ที่ใช้ในการเก็บสถานะตัวแปรในแต่ละรอบเอง การเวียนเกิดจะทำทุกอย่างเองโดยตัวแปลภาษาโปรแกรม (C++ , Python , ... ) แต่ในการวนรอบจำนวนมาก ๆ ก็อาจจะต้องใช้การวนรอบแทนเพื่อหลีกเลี่ยงที่จัดเก็บข้อมูลล้น (Stack Overflow)
